...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'plan1.title': 'Базовый корпоративный сайт',
    'plan1.desc': 'Корпоративный сайт с основными разделами: о компании, продукты и услуги, контакты, форма обратной связи. Подходит для старта и базовой презентации бизнеса.',
    'plan1.time': 'Срок разработки: 3–4 недели',
    'plan1.feature1': 'Адаптивный дизайн для всех устройств',
    'plan1.feature2': 'Базовое SEO и оптимизация',
    'plan1.feature3': 'Формы обратной связи и интеграция с CRM',
    'plan1.feature4': '',
    'plan2.title': 'Продуктовый сайт',
    'plan2.desc': 'Полноценный корпоративный сайт с детальной структурой продуктов, интеграциями, аналитикой и расширенным функционалом. Рекомендуемый вариант для масштабирования бизнеса.',
    'plan2.time': 'Срок разработки: 6–8 недель',
    'plan2.feature1': 'Полная структура продуктов и услуг',
    'plan2.feature2': 'Интеграции с CRM и аналитическими системами',
    'plan2.feature3': 'Расширенная аналитика и контроль эффективности',
    'plan2.feature4': '',
    'plan2.feature5': '',
    'plan3.title': 'Расширенный проект с админ-панелью',
    'plan3.desc': 'Комплексное решение с кастомной CMS и системой управления заявками. Полный контроль над контентом и процессами обработки обращений.',
    'plan3.time': 'Срок разработки: индивидуально',
    'plan3.feature1': 'Всё из тарифа "Продуктовый сайт"',
    'plan3.feature2': 'Кастомная CMS для управления контентом',
    'plan3.feature3': 'Админ-панель для управления заявками',
    'plan3.feature4': 'Расширенные интеграции и автоматизация',
    'plan3.feature5': '',
    'plan3.feature6': '',
