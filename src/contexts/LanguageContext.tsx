...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    // Hero
    'hero.title': 'Ваш новый сайт по уходу за пожилыми',
    'hero.subtitle': 'Создадим современную, адаптивную и понятную платформу, которая поможет клиентам быстро связаться и оформить заявку на уход. Сайт будет включать удобную систему записи, информацию о ваших услугах и специалистах, FAQ с ответами на частые вопросы, а также защищённые формы для безопасной передачи персональных данных. Платформа повысит доверие клиентов, упростит процесс оформления заявок и увеличит количество обращений.',
    ...
    'feature1.desc': 'Комплексная система коммуникации: кнопка прямого звонка, интуитивная форма заявки и автоматические письма подтверждения.\n\nКлиент может мгновенно связаться одним кликом, заполнить заявку, а система автоматически отправит подтверждение на e-mail.\n\nСнижение барьеров увеличивает конверсию на 30-40%. Лояльность растёт благодаря оперативности и прозрачности процесса.',
    'feature2.title': 'Современный адаптивный дизайн',
    'feature2.desc': 'Визуально привлекательный интерфейс с чёткой типографикой и простой навигацией, корректно отображающийся на всех устройствах.\n\nДизайн автоматически подстраивается под размер экрана, обеспечивая комфортное использование на любом устройстве.\n\nПрофессиональный вид повышает доверие и увеличивает конверсию на 25-35%. Положительный пользовательский опыт формирует лояльность и желание вернуться.',
    'feature3.title': 'FAQ с популярными вопросами',
    'feature3.desc': 'Раздел с часто задаваемыми вопросами, который экономит время клиентов и сотрудников, предоставляя быстрые ответы.\n\nКлиенты находят ответы без обращения в поддержку, а при отсутствии ответа могут задать новый вопрос через удобную форму.\n\nСнижение нагрузки на поддержку увеличивает конверсию на 20-30%. Прозрачность и открытость укрепляют доверие клиентов.',
    'feature4.title': 'Блок "Наша команда"',
    'feature4.desc': 'Презентационный раздел с фотографиями и информацией о специалистах, создающий персональную связь с клиентами.\n\nКлиенты видят реальных людей, которые будут работать с ними, узнают об их опыте и достижениях.\n\nПерсональный подход увеличивает готовность оформить заявку на 35-45%. Эмоциональная связь создаёт ощущение заботы и индивидуального подхода.',
    'feature5.title': 'Хостинг на Telekom',
    'feature5.desc': 'Размещение на надёжной инфраструктуре Telekom с высокой скоростью работы, стабильностью и безопасностью.\n\nСайт размещается на серверах с гарантированным uptime 99.9%, быстрой загрузкой и защитой от DDoS-атак.\n\nБыстрая загрузка снижает процент отказов на 40-50%. Надёжность формирует положительный опыт и укрепляет репутацию компании.',
    'feature6.title': 'Защита данных клиента',
    'feature6.desc': 'Комплексная система защиты персональных данных с шифрованием, безопасным хранением и соответствием GDPR.\n\nВсе данные передаются по HTTPS, хранятся в зашифрованном виде, доступ имеют только авторизованные сотрудники.\n\nУверенность в безопасности увеличивает конверсию на 30-40%. Забота о конфиденциальности формирует долгосрочные отношения и положительную репутацию.',
