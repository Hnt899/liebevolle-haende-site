...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'pricing.price': '650 000 ₽',
    'pricing.time': '3 месяца',
    'pricing.note': 'Стоимость хостинга не входит в цену разработки.',
    ...
    'devstep3.title': 'Фирменный брендбук',
    'devstep3.desc': 'Разрабатываем комплексный фирменный стиль компании АРКУС: логотип, цветовая палитра, типографика, графические элементы. Создаём брендбук, который отражает экспертизу компании в сфере ЖКХ и формирует узнаваемый визуальный образ надёжного IT-партнёра.',
    'devstep3.detail1': 'Разработка логотипа и фирменного стиля',
    'devstep3.detail2': 'Создание цветовой палитры и типографики',
    'devstep3.detail3': 'Формирование графических элементов и айдентики',
    'devstep4.title': 'Дизайн и визуальная концепция',
    'devstep4.desc': 'Разрабатываем профессиональный B2B-дизайн на основе созданного брендбука, который формирует образ надёжного IT-партнёра с первого взгляда. Создаём уникальный визуальный язык, отражающий экспертизу компании в сфере ЖКХ. Проектируем адаптивные интерфейсы для всех устройств с фокусом на удобство принятия решений ЛПР и максимальную конверсию.',
    'devstep4.detail1': 'Разработка визуальной концепции на основе брендбука',
    'devstep4.detail2': 'Создание адаптивных макетов для всех устройств',
    'devstep4.detail3': 'Проектирование UI/UX с фокусом на конверсию',
    'devstep5.title': 'Стек технологий',
    'devstep5.desc': 'Определяем оптимальный технологический стек для реализации проекта с учётом требований производительности, масштабируемости и долгосрочной поддержки. Выбираем современные инструменты и фреймворки, которые обеспечат стабильную работу сайта и возможность дальнейшего развития функционала.',
    'devstep5.detail1': 'Выбор технологического стека (React/TypeScript)',
    'devstep5.detail2': 'Настройка инструментов разработки и сборки',
    'devstep5.detail3': 'Планирование архитектуры и структуры проекта',
    'devstep6.title': 'Разработка и интеграции',
    ...
    'devstep6.detail1': 'Frontend-разработка на React/TypeScript',
    'devstep6.detail2': 'Интеграция с CRM и аналитическими системами',
    'devstep6.detail3': 'Настройка форм обратной связи и автоматизации',
    'devstep7.title': 'SEO и GEO оптимизация',
    'devstep7.desc': 'Проводим комплексную SEO-оптимизацию сайта для повышения видимости в поисковых системах. Настраиваем GEO-таргетинг для привлечения целевой аудитории из регионов присутствия компании АРКУС. Оптимизируем контент, мета-теги, структуру сайта и технические параметры для максимальной эффективности поискового продвижения.',
    'devstep7.detail1': 'SEO-оптимизация контента и структуры сайта',
    'devstep7.detail2': 'Настройка мета-тегов и технических параметров',
    'devstep7.detail3': 'GEO-таргетинг и региональная оптимизация',
    'devstep8.title': 'Тестирование и оптимизация',
    'devstep8.desc': 'Проводим комплексное тестирование функциональности, производительности и совместимости на всех устройствах и браузерах. Выполняем финальную оптимизацию технических параметров для максимальной эффективности. Подготавливаем к запуску, проводим обучение команды и обеспечиваем плавный переход к масштабированию.',
    'devstep8.detail1': 'Тестирование функциональности и производительности',
    'devstep8.detail2': 'Оптимизация скорости загрузки и работы сайта',
    'devstep8.detail3': 'Подготовка к запуску и обучение команды',
